...
class HuntTest(unittest.TestCase):
    ...
    def test_rabbit_should_be_eaten_when_met_one_fox(self):
        fox = Fox()
        rabbit = Rabbit()
    ...
    def test_two_rabbit_met_one_fox_one_is_eaten_the_other_survive(self):
        fox = Fox()
        rabbit_1 = Rabbit()
        rabbit_2 = Rabbit()
    ...
    def test_two_foxes_met_one_rabbit_only_one_fox_should_be_fed(self):
        fox_1 = Fox()
        fox_2 = Fox()
        rabbit = Rabbit()
